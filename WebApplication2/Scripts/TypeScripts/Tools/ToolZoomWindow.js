...
var ToolZoomWindow = /** @class */ (function () {
    function ToolZoomWindow() {
    }
    ToolZoomWindow.prototype.Start = function () {
        var inst = this;
    ...
    ToolZoomWindow.prototype.Clear = function () {
    ...
    ToolZoomWindow.prototype.End = function () {
        this.Clear();
    };
    ToolZoomWindow.prototype.MouseDown = function (evt) {
        var self = this;
        if (evt.button != 0) {
    ...
    ToolZoomWindow.prototype.MouseMove = function (evt) {
        var self = this;
    ...
    ToolZoomWindow.prototype.MouseUp = function (evt) {
        var self = this;
        if (self._mouseDownPos == null) {
            return;
        }
        ...
        layout.Controls.pan((canvasSize.x / 2) - screenWinCenter.x, (canvasSize.y / 2) - screenWinCenter.y);
        var maxVal = Math.max(box.size().y, box.size().x);
        var coeff = canvasSize.y / maxVal;
        layout.Controls.dollyIn(coeff);
    };
    ToolZoomWindow.prototype.KeyDown = function (evt) {
    };
    return ToolZoomWindow;
}());
