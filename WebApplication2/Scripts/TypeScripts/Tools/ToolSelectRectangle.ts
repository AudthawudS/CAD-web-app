...
class ToolSelectRectangle implements ITool
{
    public ItemsSelected = new CEvent<Array<SelectionItem>>();

    public SelectionItemType : SelectionType;
    ...
    public Clear()
    {
        ...
        // remove events
        this.ItemsSelected = new CEvent<Array<SelectionItem>>();
    ...
    public MouseUp(evt: JQueryMouseEventObject)
    {
        ...
        App.Layout.Selector.GetItemsByRect(box, this.SelectionItemType, (selItems: Array<SelectionItem>)=>
        {
            this.ItemsSelected.fire(selItems);
        });
